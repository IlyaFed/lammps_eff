...
class energy_h2(dash_object):
    ...
    def load_step(self, Step):
        ...
        ion_1 = parametrs[parametrs['id'] == ions[0])].apply(sum_f, axis = 1).sum()
        ion_2 = parametrs[parametrs['id'] == ions[1]].apply(sum_f, axis = 1).sum()
        electron_1 = parametrs[parametrs['id'] == electrons[0]].apply(sum_f, axis = 1).sum()
        electron_2 = parametrs[parametrs['id'] == electrons[1]].apply(sum_f, axis = 1).sum()
